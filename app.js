const CONFIG = {
  ...
  statusTexts: [
    'Claude Code：正在压缩上下文，喵～。',
    'Codex：正在执行代码修改并检查结果，喵～',
    'Kiro：正在撰写产品的需求文档，喵～',
    'WorkBuddy：正在执行代码修改并检查结果，喵～',
  ],
  prompts: {
    feed: '提示：把虾拖到猫咪身上，完成这一轮喂食。',
    status: '提示：点击猫咪，将显示当前接入的 AI 正在做什么。',
  },
  chooserNote: '请选择一种功能进行体验。完成后会出现结束提示，请再选择另外一种功能体验。你可以重复体验，但请确保两种功能都体验到。',
  repeatNote: '已完成这一种功能的体验。请选择另外一种功能进行体验；你可以重复体验，但请确保两种功能都体验到。',
};
